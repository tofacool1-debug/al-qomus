...
export default function App() {
  ...
  const getMuannasWazanPatterns = (wazanName: string | undefined): string => {
    ...
    const cleanParts = parts.map((part) => {
      ...
      if (part.includes("فَعِيلٌ")) return "فَعِيلَةٌ";
      if (part.includes("فَعَلٌ")) return "فَعَلَةٌ";
      if (part.includes("فَعْلٌ")) return "فَعْلَةٌ";
      if (part.includes("فَعِلٌ")) return "فَعِلَةٌ";
  ...
  const getJamakWazanPatterns = (
    ...
    const cleanParts = parts.map((part) => {
      ...
      if (part.includes("فَعَلٌ")) return "فِعَالٌ / أَفْعَالٌ";
      if (part.includes("فَعْلٌ")) return "فِعَالٌ / فُعُولٌ";
  ...
  const getMuntahalWazanPatterns = (
    ...
    const cleanParts = parts.map((part) => {
      ...
      if (part.includes("فَعَلٌ")) return "مَفَاعِلُ";
      return "—";
    });
    return cleanParts.join(" / ");
  };
                          ...
                          <table className="w-full text-left border-collapse">
                            ...
                            <tbody className="divide-y divide-slate-850">
                              ...
                              <tr>
                                <td className="py-3 px-4">
                                  <span className="font-semibold text-slate-200 block text-[11px]">
                                    Mufrod Mudzakkar (Laki-laki)
                                  </span>
                                  <span className="font-mono text-[9px] text-slate-500 block mt-0.5">
                                    المُفْرَدُ المُذَكَّر
                                  </span>
                                </td>
                                <td className="py-3 px-4 text-center text-slate-400 font-mono text-[11px] border-l border-slate-850">
                                  {getCleanWazanPatterns(
                                  ...
                                  <td className="py-3 px-4 text-center text-slate-400 font-mono text-[11px] border-l border-slate-850">
                                    {(() => {
                                      const wk =
                                        (structuralPlurals.sifat as any)
                                          .wazan_name || "";
                                      if (wk.includes("أَفْعَلُ"))
                                        return "أَفْعَلُ";
                                      if (wk.includes("فَعْلَانُ"))
                                        return "فَعْلَانُ";
                                      if (wk.includes("فَعِيلٌ"))
                                        return "فَعِيلٌ";
                                      if (wk.includes("فَعَلٌ"))
                                        return "فَعَلٌ";
                                      if (wk.includes("فَعْلٌ"))
                                        return "فَعْلٌ";
                                      if (wk.includes("فَعِلٌ"))
                                        return "فَعِلٌ";
                                      if (wk.includes("فَاعِلٌ"))
                                        return "فَاعِلٌ";
                                      return "Sama'i";
                                    })()}
                                  </td>
                                  ...
                                  <td className="py-3 px-4 text-center text-slate-400 font-mono text-[11px] border-l border-slate-850">
                                    {(() => {
                                      ...
                                      if (wk.includes("فَعِيلٌ")) {
                                        if (
                                          selectedEntry.bina === "Shohih" ||
                                          selectedEntry.bina === "Sahih" ||
                                          selectedEntry.bina === "Mitsal" ||
                                          selectedEntry.bina?.startsWith(
                                            "Mahmuz",
                                          )
                                        ) {
                                          return "فُعَلَاءُ";
                                        } else if (
                                          selectedEntry.bina === "Ajwaf"
                                        ) {
                                          return "فِعَالٌ";
                                        } else {
                                          return "أَفْعِلَاءُ";
                                      ...
                                      if (wk.includes("فَعَلٌ"))
                                        return "فِعَالٌ / أَفْعَالٌ";
                                      if (wk.includes("فَعْلٌ"))
                                        return "فِعَالٌ / فُعُولٌ";
                                      if (wk.includes("فَعِلٌ"))
                                        return "فَعِلُونَ / أَفْعَالٌ";
                                      if (wk.includes("فَاعِلٌ"))
                                        return "أَفْعَالٌ";
                                      return "Sama'i";
                                    })()}
