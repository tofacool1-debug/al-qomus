                            ...
                            <table className="w-full text-left border-collapse">
                              ...
                              <tbody className="divide-y divide-slate-850">
                                <tr>
                                  ...
                                  <td className="py-3.5 px-4 text-center font-arabic text-lg font-bold border-l border-slate-850">
                                    {!(structuralPlurals.sifat as any).isQiyasi && structuralPlurals.sifat.qillah && structuralPlurals.sifat.qillah !== "—" ? (
                                      <span className="text-emerald-400 select-all">{structuralPlurals.sifat.qillah}</span>
                                    ) : (
                                      <span className="text-slate-600 font-mono">(-)</span>
                                    )}
                                  </td>
                                  <td className="py-3.5 px-4 text-center font-arabic text-lg font-bold border-l border-slate-850">
                                    {(structuralPlurals.sifat as any).isQiyasi && (structuralPlurals.sifat as any).qiyasi_qillah && (structuralPlurals.sifat as any).qiyasi_qillah !== "—" ? (
                                      <span className="text-amber-400 select-all">{(structuralPlurals.sifat as any).qiyasi_qillah}</span>
                                    ) : (
                                      <span className="text-slate-600 font-mono">(-)</span>
                                    )}
                                  </td>
                                ...
                                <tr>
                                  ...
                                  <td className="py-3.5 px-4 text-center font-arabic text-lg font-bold border-l border-slate-850">
                                    {!(structuralPlurals.sifat as any).isQiyasi && structuralPlurals.sifat.katsroh && structuralPlurals.sifat.katsroh !== "—" ? (
                                      <span className="text-emerald-400 select-all">{structuralPlurals.sifat.katsroh}</span>
                                    ) : (
                                      <span className="text-slate-600 font-mono">(-)</span>
                                    )}
                                  </td>
                                  <td className="py-3.5 px-4 text-center font-arabic text-lg font-bold border-l border-slate-850">
                                    {(structuralPlurals.sifat as any).isQiyasi && (structuralPlurals.sifat as any).qiyasi_katsroh && (structuralPlurals.sifat as any).qiyasi_katsroh !== "—" ? (
                                      <span className="text-amber-400 select-all">{(structuralPlurals.sifat as any).qiyasi_katsroh}</span>
                                    ) : (
                                      <span className="text-slate-600 font-mono">(-)</span>
                                    )}
                                  </td>
                                ...
                                <tr>
                                  ...
                                  <td className="py-3.5 px-4 text-center font-arabic text-lg font-bold border-l border-slate-850">
                                    {!(structuralPlurals.sifat as any).isQiyasi && structuralPlurals.sifat.muntahal && structuralPlurals.sifat.muntahal !== "—" ? (
                                      <span className="text-emerald-400 select-all">{structuralPlurals.sifat.muntahal}</span>
                                    ) : (
                                      <span className="text-slate-600 font-mono">(-)</span>
                                    )}
                                  </td>
                                  <td className="py-3.5 px-4 text-center font-arabic text-lg font-bold border-l border-slate-850">
                                    {(structuralPlurals.sifat as any).isQiyasi && (structuralPlurals.sifat as any).qiyasi_muntahal && (structuralPlurals.sifat as any).qiyasi_muntahal !== "—" ? (
                                      <span className="text-amber-400 select-all">{(structuralPlurals.sifat as any).qiyasi_muntahal}</span>
                                    ) : (
                                      <span className="text-slate-600 font-mono">(-)</span>
                                    )}
                                  </td>
