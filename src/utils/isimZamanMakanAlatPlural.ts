...
export function analyzeIsimZamanMakanPlural(entry: DictionaryEntry): PluralIsimZamanMakan {
  ...
  if (entry.root.fa === "و") {
    defaultMufrod = `مَ${fa}ْ${ain}ِ${lam}ٌ`; // e.g. مَوْعِدٌ
  }

  switch (binaKey) {
    case "sahih":
      qillah = formatPluralList(["أَفْعِلَة", "أَفْعَال"], fa, ain, lam, binaKey);
      katsroh = formatPluralList(["فِعَال"], fa, ain, lam, binaKey);
      muntahal = formatPluralList(["مَفَاعِل"], fa, ain, lam, binaKey);
      contoh = "مَسْجِد ← مَسَاجِد";
      ilalRule = "Tidak ada I'lal pada Bina Shohih";
      explanation = `Isim Zaman & Makan untuk Bina Shohih berkembang stabil. Jamak Qillah berstruktur 'أَفْعِلَة' dan 'أَفْعَال', Jamak Katsroh berpira 'فِعَال', serta Shighot Muntahal Jumu' terpopuler mengadopsi struktur wazan 'مَفَاعِل' (seperti مَسَاجِد dari مَسْجِد).`;
      break;
    ...
    case "naqish":
      ...
      explanation = `Isim Zaman & Makan Bina Naqis dijamakkan langsung melompati Qillah/Katsroh menuju Shighot Muntahal Jumu' 'مَفَاعٍ' (seperti makhraj مَرَامٍ dari mufrod مَرْمَى).`;
      break;
    ...
    case "mudaaf":
      ...
      explanation = `Isim Zaman & Makan Bina Muda'af menggabungkan dua huruf akhirnya (Idgham kokoh) pada Shighot Muntahal Jumu' 'مَفَاعِل' sehingga berakhiran tasydid (contoh: مَقَارّ dari مَقَرّ).`;
      break;
...
export function analyzeIsimAlatPlural(entry: DictionaryEntry): PluralIsimAlat {
  ...
  switch (binaKey) {
    ...
    case "naqish":
      ...
      katsroh = formatPluralList(["مَفَاعِيل"], fa, ain, lam, binaKey);
      muntahal = formatPluralList(["مَفَاعِل"], fa, ain, lam, binaKey);
      contoh = "مِكْيَال ← مَكَايِيل";
      ilalRule = "Hazf ya";
      explanation = `Isim Alat Bina Naqis dijamakkan melalui pola jamak katsroh panjang 'مَفَاعِيل' (seperti مَكَايِيل dari mufrod مِكْيَال) setelah mengalami pelarasan huruf ya.`;
      break;
    ...
    case "mahmuz":
      ...
      katsroh = formatPluralList(["مَفَاعِيل"], fa, ain, lam, binaKey);
      muntahal = formatPluralList(["مَفَاعِل"], fa, ain, lam, binaKey);
      contoh = "مِئْzَر ← مَآزِر"; // spelling normalization
      ilalRule = "Ibdal";
      explanation = `Isim Alat Bina Mahmuz ber-I'lal santun menyatukan hamzah dengan alif mad sehingga tertulis sebagai alif maddah murni (contoh: مَآزِر dari mufrod مِئْزَر).`;
      break;
    ...
    case "lafif_maqrun":
      ...
      katsroh = formatPluralList(["مَفَاعِيل"], fa, ain, lam, binaKey);
      muntahal = formatPluralList(["مَفَاعِل"], fa, ain, lam, binaKey);
      contoh = "مِطْوَى ← مَطَاوِي";
      ilalRule = "Hazf ya/waw";
      explanation = `Isim Alat Bina Lafif Maqrun mengalir dalam katsroh berpola 'مَفَاعِيل' dan muntahal berpola 'مَفَاعِل' (contoh: مَطَاوِي).`;
      break;
    ...
    case "lafif_mafruq":
      ...
      katsroh = formatPluralList(["مَفَاعِيل"], fa, ain, lam, binaKey);
      muntahal = formatPluralList(["مَفَاعِل"], fa, ain, lam, binaKey);
      contoh = "مِيقَى ← مَوَاقِي";
      ilalRule = "Hazf ya/waw";
      explanation = `Isim Alat Bina Lafif Mafruq melestarikan sifat keselarasan makhraj murni melahirkan jamak 'مَفَاعِيل' dan 'مَفَاعِل' (contoh: مَوَاقِي).`;
      break;
  }
