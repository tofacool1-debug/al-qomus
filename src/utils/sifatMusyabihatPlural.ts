...
export function analyzeSifatMusyabihatPlural(entry: DictionaryEntry): PluralSifatMusyabihat {
  ...
  return {
    katsroh: cleanArabicWords(isSamai ? katsroh : "—"),
    qillah: cleanArabicWords(isSamai ? qillah : "—"),
    muntahal: cleanArabicWords(isSamai ? muntahal : "—"),
    isQiyasi,
    isSamai,
    qiyasi_katsroh: cleanArabicWords(isQiyasi ? katsroh : "—"),
    qiyasi_qillah: cleanArabicWords(isQiyasi ? qillah : "—"),
    qiyasi_muntahal: cleanArabicWords(isQiyasi ? muntahal : "—"),
